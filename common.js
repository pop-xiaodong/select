...
var SelectPropTypes = {
  ...
  renderMenu: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Select__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Option__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PropTypes__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__OptGroup__ = __webpack_require__(15);
...
throw new Error("Cannot find module \"rc-util/lib/Children/toArray\"");
throw new Error("Cannot find module \"classnames\"");
throw new Error("Cannot find module \"rc-animate\"");
throw new Error("Cannot find module \"component-classes\"");
throw new Error("Cannot find module \"rc-menu\"");
throw new Error("Cannot find module \"warning\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Option__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__util__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__SelectTrigger__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__PropTypes__ = __webpack_require__(8);
...
var Select = function (_React$Component) {
  ...
  function Select(props) {
    ...
    _this.saveInputRef = Object(__WEBPACK_IMPORTED_MODULE_11__util__["q" /* saveRef */])(_this, 'inputRef');
    _this.saveInputMirrorRef = Object(__WEBPACK_IMPORTED_MODULE_11__util__["q" /* saveRef */])(_this, 'inputMirrorRef');
    _this.saveTopCtrlRef = Object(__WEBPACK_IMPORTED_MODULE_11__util__["q" /* saveRef */])(_this, 'topCtrlRef');
    _this.saveSelectTriggerRef = Object(__WEBPACK_IMPORTED_MODULE_11__util__["q" /* saveRef */])(_this, 'selectTriggerRef');
    _this.saveRootRef = Object(__WEBPACK_IMPORTED_MODULE_11__util__["q" /* saveRef */])(_this, 'rootRef');
    _this.saveSelectionRef = Object(__WEBPACK_IMPORTED_MODULE_11__util__["q" /* saveRef */])(_this, 'selectionRef');
    return _this;
  }
  ...
  Select.prototype.componentDidUpdate = function componentDidUpdate() {
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(this.props)) {
  ...
  Select.prototype.componentWillUnmount = function componentWillUnmount() {
    ...
    if (this.dropdownContainer) {
      __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.unmountComponentAtNode(this.dropdownContainer);
  ...
  Select.prototype.focus = function focus() {
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["o" /* isSingleMode */])(this.props)) {
  ...
  Select.prototype.renderClear = function renderClear() {
    ...
    var clear = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', _extends({
      key: 'clear',
      onMouseDown: __WEBPACK_IMPORTED_MODULE_11__util__["p" /* preventDefaultEvent */],
      style: __WEBPACK_IMPORTED_MODULE_11__util__["b" /* UNSELECTABLE_STYLE */]
    }, __WEBPACK_IMPORTED_MODULE_11__util__["a" /* UNSELECTABLE_ATTRIBUTE */], {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["l" /* isCombobox */])(this.props)) {
      if (inputValue) {
        return clear;
      }
      return null;
  ...
  Select.prototype.render = function render() {
    ...
    var multiple = Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(props);
    ...
    if (!Object(__WEBPACK_IMPORTED_MODULE_11__util__["n" /* isMultipleOrTagsOrCombobox */])(props)) {
      extraSelectionProps = {
        onKeyDown: this.onKeyDown,
        tabIndex: props.disabled ? -1 : 0
      };
    }
    var rootCls = (_rootCls = {}, _rootCls[className] = !!className, _rootCls[prefixCls] = 1, _rootCls[prefixCls + '-open'] = open, _rootCls[prefixCls + '-focused'] = open || !!this._focused, _rootCls[prefixCls + '-combobox'] = Object(__WEBPACK_IMPORTED_MODULE_11__util__["l" /* isCombobox */])(props), _rootCls[prefixCls + '-disabled'] = disabled, _rootCls[prefixCls + '-enabled'] = !disabled, _rootCls[prefixCls + '-allow-clear'] = !!props.allowClear, _rootCls[prefixCls + '-no-arrow'] = !props.showArrow, _rootCls);
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        {
          ...
          className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()(rootCls)
        },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          _extends({
          ...
          ctrlNode,
          this.renderClear(),
          multiple || !props.showArrow ? null : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'span',
            _extends({
              key: 'arrow',
...
Select.propTypes = __WEBPACK_IMPORTED_MODULE_13__PropTypes__["a" /* SelectPropTypes */];
Select.defaultProps = {
  prefixCls: 'rc-select',
  defaultOpen: false,
  labelInValue: false,
...
Select.getInputValueForCombobox = function (props, optionsInfo, useDefaultValue) {
  ...
  if ('value' in props && !useDefaultValue) {
    value = Object(__WEBPACK_IMPORTED_MODULE_11__util__["s" /* toArray */])(props.value);
  }
  if ('defaultValue' in props && useDefaultValue) {
    value = Object(__WEBPACK_IMPORTED_MODULE_11__util__["s" /* toArray */])(props.defaultValue);
  }
  if (value.length) {
    value = value[0];
  } else {
  ...
  if (props.labelInValue) {
    label = value.label;
  } else if (optionsInfo[Object(__WEBPACK_IMPORTED_MODULE_11__util__["g" /* getMapKey */])(value)]) {
    label = optionsInfo[Object(__WEBPACK_IMPORTED_MODULE_11__util__["g" /* getMapKey */])(value)].label;
  }
  if (label === undefined) {
    label = '';
  }
...
Select.getLabelFromOption = function (props, option) {
  return Object(__WEBPACK_IMPORTED_MODULE_11__util__["h" /* getPropValue */])(option, props.optionLabelProp);
};
...
Select.getOptionsInfoFromProps = function (props, preState) {
  ...
  options.forEach(function (option) {
    var singleValue = Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(option);
    optionsInfo[Object(__WEBPACK_IMPORTED_MODULE_11__util__["g" /* getMapKey */])(singleValue)] = {
      option: option,
      value: singleValue,
  ...
  if (preState) {
    ...
    value.forEach(function (v) {
      var key = Object(__WEBPACK_IMPORTED_MODULE_11__util__["g" /* getMapKey */])(v);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onInputChange = function (event) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(_this2.props) && tokenSeparators.length && Object(__WEBPACK_IMPORTED_MODULE_11__util__["k" /* includesSeparators */])(val, tokenSeparators)) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["l" /* isCombobox */])(_this2.props)) {
  ...
  this.onKeyDown = function (event) {
    ...
    } else if (keyCode === __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_KeyCode___default.a.ENTER || keyCode === __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_KeyCode___default.a.DOWN) {
  ...
  this.onInputKeyDown = function (event) {
    ...
    var keyCode = event.keyCode;
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(props) && !event.target.value && keyCode === __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_KeyCode___default.a.BACKSPACE) {
      event.preventDefault();
    ...
    if (keyCode === __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_KeyCode___default.a.DOWN) {
      if (!state.open) {
    ...
    } else if (keyCode === __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_KeyCode___default.a.ENTER && state.open) {
      // Aviod trigger form submit when select item
      // https://github.com/ant-design/ant-design/issues/10861
      event.preventDefault();
    } else if (keyCode === __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_KeyCode___default.a.ESC) {
      if (state.open) {
  ...
  this.onMenuSelect = function (_ref) {
    ...
    var props = _this2.props;
    var selectedValue = Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(item);
    var lastValue = value[value.length - 1];
    _this2.fireSelect(selectedValue);
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(props)) {
      if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["e" /* findIndexInValueBySingleValue */])(value, selectedValue) !== -1) {
        return;
      }
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["l" /* isCombobox */])(props)) {
      inputValue = Object(__WEBPACK_IMPORTED_MODULE_11__util__["h" /* getPropValue */])(item, props.optionLabelProp);
    } else {
      inputValue = '';
    }
  ...
  this.onMenuDeselect = function (_ref2) {
    ...
    if (domEvent.type === 'click') {
      _this2.removeSelected(Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(item));
    }
    var props = _this2.props;
  ...
  this.onOuterFocus = function (e) {
    ...
    _this2.clearBlurTime();
    if (!Object(__WEBPACK_IMPORTED_MODULE_11__util__["n" /* isMultipleOrTagsOrCombobox */])(_this2.props) && e.target === _this2.getInputDOMNode()) {
      return;
    }
    if (_this2._focused) {
      return;
  ...
  this.onOuterBlur = function (e) {
    ...
    _this2.blurTimer = setTimeout(function () {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["o" /* isSingleMode */])(props) && props.showSearch && inputValue && props.defaultActiveFirstOption) {
        var options = _this2._options || [];
        if (options.length) {
          var firstOption = Object(__WEBPACK_IMPORTED_MODULE_11__util__["d" /* findFirstMenuItem */])(options);
          if (firstOption) {
            value = [Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(firstOption)];
            _this2.fireChange(value);
          }
        }
      } else if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(props) && inputValue) {
  ...
  this.getOptionInfoBySingleValue = function (value, optionsInfo) {
    ...
    if (optionsInfo[Object(__WEBPACK_IMPORTED_MODULE_11__util__["g" /* getMapKey */])(value)]) {
      info = optionsInfo[Object(__WEBPACK_IMPORTED_MODULE_11__util__["g" /* getMapKey */])(value)];
    }
    if (info) {
      return info;
    }
    ...
    if (_this2.props.labelInValue) {
      var label = Object(__WEBPACK_IMPORTED_MODULE_11__util__["f" /* getLabelFromPropsValue */])(_this2.props.value, value);
      if (label !== undefined) {
        defaultLabel = label;
      }
    }
    var defaultInfo = {
      option: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_10__Option__["a" /* default */],
  ...
  this.getValueByLabel = function (label) {
    ...
    Object.keys(_this2.state.optionsInfo).forEach(function (key) {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["s" /* toArray */])(info.label).join('') === label) {
        value = info.value;
      }
    });
    return value;
  ...
  this.getVLForOnChange = function (vls_) {
    ...
    if (vls !== undefined) {
      ...
      return Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(_this2.props) ? vls : vls[0];
    }
    return vls;
  };
  ...
  this.getPlaceholderElement = function () {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["l" /* isCombobox */])(props) && state.value.length === 1 && !state.value[0]) {
      hidden = false;
    }
    ...
    if (placeholder) {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        _extends({
          ...
          }, __WEBPACK_IMPORTED_MODULE_11__util__["b" /* UNSELECTABLE_STYLE */])
        }, __WEBPACK_IMPORTED_MODULE_11__util__["a" /* UNSELECTABLE_ATTRIBUTE */], {
  ...
  this.getInputElement = function () {
    ...
    var props = _this2.props;
    var inputElement = props.getInputElement ? props.getInputElement() : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { id: props.id, autoComplete: 'off' });
    var inputCls = __WEBPACK_IMPORTED_MODULE_5_classnames___default()(inputElement.props.className, (_classnames = {}, _classnames[props.prefixCls + '-search__field'] = true, _classnames));
    // https://github.com/ant-design/ant-design/issues/4992#issuecomment-281542159
    // Add space to the end of the inputValue as the width measurement tolerance
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: props.prefixCls + '-search__field__wrap' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.cloneElement(inputElement, {
  ...
  this.setOpenState = function (open, needFocus) {
    ...
    if (!open && Object(__WEBPACK_IMPORTED_MODULE_11__util__["o" /* isSingleMode */])(props) && props.showSearch) {
      _this2.setInputValue('', false);
    }
    if (!open) {
      _this2.maybeFocus(open, needFocus);
  ...
  this.getValueByInput = function (string) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_11__util__["r" /* splitBySeparators */])(string, tokenSeparators).forEach(function (label) {
      var selectedValue = [label];
      if (multiple) {
        var value = _this2.getValueByLabel(label);
        if (value && Object(__WEBPACK_IMPORTED_MODULE_11__util__["e" /* findIndexInValueBySingleValue */])(nextValue, value) === -1) {
        ...
        // tag
        if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["e" /* findIndexInValueBySingleValue */])(nextValue, label) === -1) {
  ...
  this.getRealOpenState = function () {
    ...
    var options = _this2._options || [];
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["n" /* isMultipleOrTagsOrCombobox */])(_this2.props) || !_this2.props.showSearch) {
  ...
  this.handleBackfill = function (item) {
    if (!_this2.props.backfill || !(Object(__WEBPACK_IMPORTED_MODULE_11__util__["o" /* isSingleMode */])(_this2.props) || Object(__WEBPACK_IMPORTED_MODULE_11__util__["l" /* isCombobox */])(_this2.props))) {
      return;
    }

    var key = Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(item);
  ...
  this.filterOption = function (input, child) {
    var defaultFilter = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : __WEBPACK_IMPORTED_MODULE_11__util__["c" /* defaultFilterFn */];
    var value = _this2.state.value;
  ...
  this.updateFocusClassName = function () {
    ...
    if (_this2._focused) {
      __WEBPACK_IMPORTED_MODULE_7_component_classes___default()(rootRef).add(props.prefixCls + '-focused');
    } else {
      __WEBPACK_IMPORTED_MODULE_7_component_classes___default()(rootRef).remove(props.prefixCls + '-focused');
    }
  };
  ...
  this.maybeFocus = function (open, needFocus) {
    if (needFocus || open) {
      ...
      if (input && (open || Object(__WEBPACK_IMPORTED_MODULE_11__util__["n" /* isMultipleOrTagsOrCombobox */])(_this2.props))) {
  ...
  this.removeSelected = function (selectedKey, e) {
    ...
    var canMultiple = Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(props);
  ...
  this.openIfHasChildren = function () {
    var props = _this2.props;
    if (__WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.count(props.children) || Object(__WEBPACK_IMPORTED_MODULE_11__util__["o" /* isSingleMode */])(props)) {
      _this2.setOpenState(true);
    }
  };
  ...
  this.fireChange = function (value) {
    ...
    props.onChange(vls, Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(_this2.props) ? options : options[0]);
  };

  this.isChildDisabled = function (key) {
    return __WEBPACK_IMPORTED_MODULE_4_rc_util_lib_Children_toArray___default()(_this2.props.children).some(function (child) {
      var childValue = Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(child);
  ...
  this.renderFilterOptions = function () {
    ...
    if (tags) {
      ...
      value.forEach(function (singleValue) {
        var key = singleValue;
        var menuItem = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_8_rc_menu__["Item"],
          {
            style: __WEBPACK_IMPORTED_MODULE_11__util__["b" /* UNSELECTABLE_STYLE */],
            role: 'option',
            attribute: __WEBPACK_IMPORTED_MODULE_11__util__["a" /* UNSELECTABLE_ATTRIBUTE */],
            value: key,
            key: key
          },
          key
      ...
      if (inputValue) {
        var notFindInputItem = menuItems.every(function (option) {
          ...
          var filterFn = function filterFn() {
            return Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(option) === inputValue;
          };
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.forEach(children, function (child) {
      ...
      if (child.type.isSelectOptGroup) {
        ...
        if (innerItems.length) {
          ...
          sel.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_8_rc_menu__["ItemGroup"],
            { key: key, title: label },
            innerItems
          ));
        }
      ...
      __WEBPACK_IMPORTED_MODULE_9_warning___default()(child.type.isSelectOption, 'the children of `Select` should be `Select.Option` or `Select.OptGroup`, ' + ('instead of `' + (child.type.name || child.type.displayName || child.type) + '`.'));

      var childValue = Object(__WEBPACK_IMPORTED_MODULE_11__util__["j" /* getValuePropValue */])(child);

      Object(__WEBPACK_IMPORTED_MODULE_11__util__["u" /* validateOptionValue */])(childValue, _this2.props);

      if (_this2.filterOption(inputValue, child)) {
        var menuItem = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_rc_menu__["Item"], _extends({
          style: __WEBPACK_IMPORTED_MODULE_11__util__["b" /* UNSELECTABLE_STYLE */],
          attribute: __WEBPACK_IMPORTED_MODULE_11__util__["a" /* UNSELECTABLE_ATTRIBUTE */],
          value: childValue,
          key: childValue,
  ...
  this.renderTopControlNode = function () {
    ...
    var innerNode = null;
    if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["o" /* isSingleMode */])(props)) {
      ...
      if (value.length) {
        ...
        selectedValue = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          {
            key: 'value',
            className: prefixCls + '-selection-selected-value',
            title: Object(__WEBPACK_IMPORTED_MODULE_11__util__["t" /* toTitle */])(title || label),
            style: {
      ...
      if (!showSearch) {
        ...
        innerNode = [selectedValue, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          {
      ...
      if (maxTagCount !== undefined && value.length > maxTagCount) {
        ...
        maxTagPlaceholderEl = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'li',
          _extends({
            style: __WEBPACK_IMPORTED_MODULE_11__util__["b" /* UNSELECTABLE_STYLE */]
          }, __WEBPACK_IMPORTED_MODULE_11__util__["a" /* UNSELECTABLE_ATTRIBUTE */], {
            ...
            title: Object(__WEBPACK_IMPORTED_MODULE_11__util__["t" /* toTitle */])(content)
          }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
        ...
        selectedValueNodes = limitedCountValue.map(function (singleValue) {
          ...
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            _extends({
              ...
              key: singleValue,
              title: Object(__WEBPACK_IMPORTED_MODULE_11__util__["t" /* toTitle */])(title)
            }),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              'div',
              { className: prefixCls + '-selection__choice__content' },
            ...
            disabled ? null : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', {
      ...
      selectedValueNodes.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'li',
        {
          className: prefixCls + '-search ' + prefixCls + '-search--inline',
          key: '__input'
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_11__util__["m" /* isMultipleOrTags */])(props) && choiceTransitionName) {
        innerNode = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_6_rc_animate___default.a,
          {
...
Object(__WEBPACK_IMPORTED_MODULE_2_react_lifecycles_compat__["polyfill"])(Select);
...
throw new Error("Cannot find module \"prop-types\"");
throw new Error("Cannot find module \"classnames\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__DropdownMenu__ = __webpack_require__(14);
throw new Error("Cannot find module \"react-dom\"");
...
__WEBPACK_IMPORTED_MODULE_0_rc_trigger___default.a.displayName = 'Trigger';
...
var SelectTrigger = function (_React$Component) {
  ...
  function SelectTrigger(props) {
    ...
    _this.saveDropdownMenuRef = Object(__WEBPACK_IMPORTED_MODULE_6__util__["q" /* saveRef */])(_this, 'dropdownMenuRef');
    _this.saveTriggerRef = Object(__WEBPACK_IMPORTED_MODULE_6__util__["q" /* saveRef */])(_this, 'triggerRef');
  ...
  SelectTrigger.prototype.render = function render() {
    ...
    if (disabled) {
      hideAction = [];
    } else if (Object(__WEBPACK_IMPORTED_MODULE_6__util__["o" /* isSingleMode */])(props) && !showSearch) {
      hideAction = ['click'];
    } else {
      hideAction = ['blur'];
    }
    ...
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
      __WEBPACK_IMPORTED_MODULE_0_rc_trigger___default.a,
      _extends({}, props, {
        ...
        getPopupContainer: props.getPopupContainer,
        popupClassName: __WEBPACK_IMPORTED_MODULE_3_classnames___default()(popupClassName),
...
SelectTrigger.propTypes = {
  onPopupFocus: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  onPopupScroll: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  dropdownMatchSelectWidth: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  dropdownAlign: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object,
  ...
  dropdownClassName: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  ...
  filterOption: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.any,
  options: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.any,
  ...
  showAction: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string)
};
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setDropdownWidth = function () {
    var width = __WEBPACK_IMPORTED_MODULE_5_react_dom___default.a.findDOMNode(_this2).offsetWidth;
  ...
  this.getDropdownElement = function (newProps) {
    var props = _this2.props;
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__DropdownMenu__["a" /* default */], _extends({
...
throw new Error("Cannot find module \"rc-util/lib/Children/toArray\"");
throw new Error("Cannot find module \"rc-menu\"");
throw new Error("Cannot find module \"dom-scroll-into-view\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util__ = __webpack_require__(6);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var DropdownMenu = function (_React$Component) {
  ...
  function DropdownMenu(props) {
    ...
    _this.saveMenuRef = Object(__WEBPACK_IMPORTED_MODULE_6__util__["q" /* saveRef */])(_this, 'menuRef');
    return _this;
  }
  ...
  DropdownMenu.prototype.renderMenu = function renderMenu() {
    ...
    if (menuItems && menuItems.length) {
      ...
      var selectedKeys = Object(__WEBPACK_IMPORTED_MODULE_6__util__["i" /* getSelectKeys */])(menuItems, value);
      var activeKeyProps = {};
      ...
      if (selectedKeys.length || firstActiveValue) {
        ...
        clonedMenuItems = menuItems.map(function (item) {
          if (item.type.isMenuItemGroup) {
            var children = __WEBPACK_IMPORTED_MODULE_3_rc_util_lib_Children_toArray___default()(item.props.children).map(clone);
            return Object(__WEBPACK_IMPORTED_MODULE_0_react__["cloneElement"])(item, {}, children);
          }
          return clone(item);
        });
      } else {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_4_rc_menu___default.a,
        _extends({
  ...
  DropdownMenu.prototype.render = function render() {
    ...
    return renderMenu ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      {
        style: { overflow: 'auto' },
        onFocus: this.props.onPopupFocus,
        onMouseDown: __WEBPACK_IMPORTED_MODULE_6__util__["p" /* preventDefaultEvent */],
...
DropdownMenu.propTypes = {
  defaultActiveFirstOption: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  value: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.any,
  dropdownMenuStyle: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object,
  multiple: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool,
  onPopupFocus: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  onPopupScroll: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  onMenuDeSelect: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  onMenuSelect: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func,
  prefixCls: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  menuItems: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.any,
  inputValue: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  visible: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool
};
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.scrollActiveItemToView = function () {
    // scroll into view
    var itemComponent = Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["findDOMNode"])(_this3.firstActiveItem);
    ...
    if (itemComponent) {
      ...
      __WEBPACK_IMPORTED_MODULE_5_dom_scroll_into_view___default()(itemComponent, Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["findDOMNode"])(_this3.menuRef), scrollIntoViewOpts);
    }
  };
};
